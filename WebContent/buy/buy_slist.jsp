								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										...
										<ul class="nav nav-tabs" data-tabs="tabs">
											...
											<li><a class="btn btn-danger" onclick="move();">LIST
													전체보기 </a></li>
											<c:if test="${sessionScope.Level eq 6 }">
												<li><a class="btn btn-default" onclick="m_insert();">이동
														insert</a></li>
											</c:if>
											<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</li>
											<li><input type="text" class="form-control" id="Keyword"
												value="" placeholder="검색어를 입력하세요."></li>
											<li><a class="btn btn-default" onclick="Keysearch();">검색</a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="Exercise">
										<form action="" name="form2" id="form2">
											<input type="hidden" name="bigtype" id="bigtype"
												value="exercise">
											<table class="table" style="border-bottom: 1px solid gray;">
												<tbody>
													<tr>
						...
						<div class="col-lg-12">
							<c:forEach var="j" items="${v}" varStatus="status">
								<c:if test="${status.count%3==1 }">
									...
									<div class="row" id="row${status.count }">
										<!--row1, row4  -->
								</c:if>
								<div class="col-lg-4">
									<div class="card">
										<div class="card-header card-chart"
											...
											<div class="ct-chart" id="dailySalesChart">
												<a href="#" onclick="read('${j.name}')"> <img
													src="./upload/${j.img }"
										...
										<div class="card-content">
											...
											<p class="category text-center">
												<span class="text-success"> ￦${j.price } </span>
											</p>
										</div>
										<div class="card-footer">
											<div class="stats">${j.sexpl }</div>
										</div>
									</div>
				...
				<div class="col-lg-2 col-md-2">
					<div class="card card-nav-tabs">
						<div class="card-header" data-background-color="purple">
							<div class="nav-tabs-wrapper">오늘 본 품목</div>
						</div>
						<div class="card-content">
							<div class="tab-content">
								<div>
