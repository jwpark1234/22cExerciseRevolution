...
<meta charset="utf-8" />
	...
	<script type="text/javascript">
	 function update(num){
		 ...
		 var  read_Tip = $('#read_Tip').serialize();

			// 직렬화한 데이터를 회원가입,수정 서블릿으로 전달한다.
		       $.ajax({
		         url:"tip_board_update.do",
		         dataType:'html',
		         data:read_Tip,
		         type:'post',
		...
		<div class="content">
			<div class="card">
				<div class="card-header" style="background: linear-gradient(60deg, #00bcd4, #eee);">
 				...
 				<form action="tip_board_update.do" method="post" style="width:100%; text-align: center;">
 				<input type="hidden" class="form-control" name="Tip_update_num" id="Tip_update_num" value="${num }">
				<table class="table table-striped" style="margin:0 auto !important; text-align: center; border: 1px solid #dddddd;">
					<tbody>
 						<tr>
  							<td><input type="text" class="form-control" name="Tip_update_subject" id="Tip_update_subject" maxlength="50" value="${subject }"></td>
						</tr>
						<tr>
 							<td align=left><textarea class="summernote" name="Tip_update_content" id="Tip_update_content" maxlength="2048" style="height: 350px;">${content }</textarea></td>
     					</tr>
    				</tbody>
   				</table>
