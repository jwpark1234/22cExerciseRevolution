...
<script src="./assets/js/summernote-ko-KR.js"></script>
	...
	<script type="text/javascript">
		function write_click() {
			...
			var write = $('#Tip_writeForm').serialize();

			// 직렬화한 데이터를 회원가입,수정 서블릿으로 전달한다.
		       $.ajax({
		         url:"tip_board_write_Action.do",
		         dataType:'html',
		         data:write,
		         type:'post',
   ...
   <form id="Tip_writeForm" method="post" style="width:100%;">
   <table class="table table-striped">
    <tbody>
     <tr>
      <td><input type="text" class="form-control" placeholder="글제목" name="Subject" maxlength="50"></td>
     ...
     <tr>
     	<td style="padding: 30px 8px;" colspan="3">
     	 <div class="controls" >
  ...
  <a style="display:inline;" class="btn btn-primary pull-right" href="board_Tip.do?pageNum=1">글목록</a>
 </form> 
</div>
</div>
</div>
